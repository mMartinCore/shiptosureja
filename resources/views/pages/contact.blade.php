...
-->
<body class="bg-white text-blue-900 px-8 py-12">
                    ...
                    @if ($message = Session::get('success'))
                        ...
                        <div class="text-white px-6 py-4 border-0 rounded relative mb-4 bg-green-500">
                            ...
                            <span class="inline-block align-middle mr-8">
                              <b class="capitalize">Thanks you!</b>  {{ $message }}
                            </span>
    ...
    <div
                                                                                                                   {{-- bg-gray-100 bg-blue-300 --}}
      class="max-w-screen-xl mt-24 px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto   text-blue-900 rounded-lg shadow-lg">
      <div class="flex flex-col justify-between">
        <div>

          <h2 class="text-4xl lg:text-5md font-bold leading-tight">Let's talk about everything!</h2>
          <div class="text-gray-700 text-xl mt-8">
            <p class="text-blue-700 block ">Cellphone :   <span class="text-blue-900   "> 876 - 813 - 1312</span></p>
            <p class="text-blue-700 block ">WhatsApp :   <span class="text-blue-900   "> 876 - 831 - 7012</span></p>

            <p class="text-blue-700 block ">Join Us on</p>
        ...
        <div class="mt-8 text-center">
          ...
          <p class="uppercase text-sm text-blue-700 font-bold mt-2" >
              remember we  deliver to a location of your choice !
          </p>
        </div>
      </div>
      <div class="">
        <form class="w-full p-6" method="POST" action="{{ route('send.mail') }}">
          @csrf
                <div>
                <span class="uppercase text-sm text-gray-600 font-bold">Full Name</span>
                <input name="name"  value="{{ old('name') }}" required autocomplete=off  class="
                  @error('name') border-red-500 @enderror w-full bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"  type="text"  >
                        @error('name')
                ...
                <input name="email" email  value="{{ old('email') }}" required autocomplete=off  class="   @error('email') border-red-500 @enderror  w-full bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"  type="text">
                @error('email')
                <p class="text-red-700 text-sm italic mt-4">
                    {{ $message }}
                </p>
                ...
                value="{{ old('message_value') }}" required autocomplete=off  class="   @error('message_value') border-red-500 @enderror w-full h-32 bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"></textarea>
                    @error('message_value')
                    <p class="text-red-700 text-sm italic mt-4">
                        {{ $message }}
                    </p>
