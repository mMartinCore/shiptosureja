...
@section('content')
<div class="pt-24 font-serif">

	<div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
		<!--Left Col-->
		<div class="flex  -mt-24 text-gray-700 flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
			{{-- <p class="uppercase tracking-loose w-full">What business are you?</p> --}}
			<h1 class="my-4 text-5xl xs:text-sm font-bold leading-tight">Sign up once and do unlimited shipping</h1>
			<p class="leading-normal xs:text-sm  text-blue-700 text-2xl mb-8">Ship to Sure Ja will do the rest!</p>




            <a  href="https://sts.shiptojm.com/Account/Register"  class="mx-auto lg:mx-0 hover:underline bg-green-500 text-green-100 font-bold rounded-full my-6 py-4 px-12 shadow-2xl hover:bg-blue-400">GET STARTED</a>


            <div id="myAnimatiomation">

                   <div id="flip">
                     <div><div > We are Convienent!</div></div>
                     <div><div>We are Reliable!</div></div>
                     <div><div> We are Secure!</div></div> 
                   </div>
                 </div>
        ...
        <div class="w-full md:w-3/5 py-6 text-center">
            {{-- <svg class="fill-current " width="30%" height="30%" viewBox="0 0 48 48" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" xmlns:serif="http://www.serif.com/" style="fill-rule: evenodd; clip-rule: evenodd; stroke-linejoin: round; stroke-miterlimit: 2;">
...
<section class="bg-white border-b py-8 font-serif">
	<div class="container max-w-5xl mx-auto m-8">
		<h1 class="w-full my-2 text-5xl font-bold leading-tight text-center text-gray-800">GET STARTED </h1>
		...
		<div class="flex flex-wrap">
			<div class="w-5/6 sm:w-1/2 p-6">
				<h3 class="text-3xl text-blue-900 font-bold leading-none mb-4">Buy from your favorite online store with your own unique USA shipping <span class="text-blue-800 uppercase">address</span></h3>
				<p class="text-gray-700 mb-0 text-lg">Experience our reliability when you ship with us. We offer competitive rates and a speedy delivery service. If you reside within the areas of
                    <ul class="list-disc ml-4 text-gray-600 mb-0 text-lg">
                        <li>Kingston</li>
                        <li>Portmore</li>
                        <li>Spanish Town or Old Harbour</li>
                      </ul>
                      <p class="text-gray-700 mb-8 text-lg">
                       you’re in luck as we provide a <span  class="text-green-700 uppercase mb-8 px-1 text-xl">free delivery service </span>  to these locations.
                       <span id="str" ></span>
                        </p><br /><br />
...
<script>
    var string ="All other locations may attract a small delivery fee.";
var str = string.split("");
var el = document.getElementById('str');

	/*Apply classes for text animation*/
	document.addEventListener('scroll', function() {
	var scroll_postion = window.scrollY;

    if(scroll_postion > 800){
   ...
   (function animate() {
        ...
        <div class="w-full bg-white relative">
            ...
            <!-- title -->
            <div class="text-center px-6 py-12 mb-6 bg-red-500 border-b">
                <h1 class=" text-xl md:text-4xl pb-4">Door step delivery</h1>
                <p class="leading-loose bg-blue-900">
                    All Packages will be delivered to a location of your choice
                </p>
            </div>

            <div class="border shadow-lg border-gray-400 bg-white rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal">
            <div class="container mx-auto pb-2   ">

                <div class="flex flex-wrap justify-start items-start ">

                    <div class="w-full text-blue-900 bg-white-100  text-xl md:w-1/2 p-2">
                        <span class="text-gray-700 font-bold text-base text-2xl pb-2">Do not have a credit/debit card ? use ours</span><br>
                             If you require any assistance feel free to contact us at any time.
                             You may also connect with us via WhatsApp, Facebook, and Instagram.
                    ...
                    <div class="w-full md:w-1/2   bg-white-100 ">
                        <div class="overflow-hidden rounded-sm border   shadow-lg">
                            <img  class="shadow-lg rounded-sm" src="{{asset('/image/weship.jpeg')}}"  width="600px">
                        </div>
...
<!-- component -->
<div class="flex md:flex-row flex-col max-w-6xl m-auto my-10">
    <div class="md:w-1/3 p-4 flex justify-center items-center bg-gray-700 mx-2 rounded">
		...
		<div class="flex flex-wrap flex-col-reverse sm:flex-row">
			...
			<div class="w-full sm:w-1/2 p-6 mt-6">
				<div class="align-middle">
					<h3 class="text-3xl text-gray-800 font-bold leading-none mb-3"> Shop online and ship  with us</h3>
					<p class="text-gray-600 text-2xl mb-8">Sign up once and do unlimited shipping.
                        Buy from your favorite online store with your own unique USA shipping address
                        Eg. Ebay, Amazon, Fashion Nova, Tory Burch etc.
                        Ship to Sure Ja will do the rest.
                        Rates as low as   <span class="text-xs font-semibold inline-block py-1 px-2 uppercase rounded-full text-2xl text-green-600 bg-green-200 uppercase last:mr-0 mr-1">
                            $300
                          </span> JMD.
                        .</p>
				</div>
...
<section class="container mx-auto text-center py-6 mb-12 ">
	...
	<h1 class="w-full my-2 text-5xl font-bold leading-tight text-center text-gray-700"> SHIP TO SURE with us today</h1>
	<div class="w-full mb-4">
		<div class="h-1 mx-auto bg-white w-3/6 opacity-25 my-0 py-0 rounded-t"></div>
	</div>

	<h3 class="my-4 mb-12 text-3xl leading-tight text-gray-600">Sign up once and do unlimited shipping!</h3>

    <a  href="https://sts.shiptojm.com/Account/Register"  class="mx-auto   lg:mx-0 hover:underline bg-green-500 text-green-100 font-bold rounded-full  py-4 px-12 shadow-2xl hover:bg-blue-400">GET STARTED</a>
