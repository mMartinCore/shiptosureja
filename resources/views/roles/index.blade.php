                ...
                <div class="p-0">
                    <div class="flex justify-start items-baseline flex-wrap">
                        ...
                        border-teal-600 transition">
                            ...
                            <a href="{{ URL::to('roles/create') }}" class="text-base  rounded-r-none  hover:scale-110 focus:outline-none flex justify-center px-4 py-2 rounded font-bold cursor-pointer
                            hover:bg-teal-700 hover:text-teal-100
                            bg-teal-100
                            text-teal-700
                            border duration-200 ease-in-out
		...
		<table class="w-full flex flex-row flex-no-wrap sm:bg-white rounded-lg overflow-hidden sm:shadow-lg my-5">
			...
			<tbody class="flex-1 sm:flex-none">
                ...
                <tr class="flex flex-col flex-no wrap sm:table-row border bg-gray-100   hover:bg-gray-100  mb-2 sm:mb-0 text-gray-900">
                    ...
                    <td class="border-grey-light border   p-2">{{ $role->name }}</td>
                    <td class="border-grey-light border   p-2">{{$role->permissions()->pluck('name')->implode(' ') }}</td>
                    <td class="border-grey-light border   p-2 text-red-400 hover:text-red-600 hover:font-medium cursor-pointer">

        <div class="flex m-2">
            <a href="{{ URL::to('roles/'.$role->id.'/edit') }}"  class="text-base  rounded-r-none p-1  hover:scale-110 focus:outline-none flex justify-center  rounded font-bold cursor-pointer
        hover:bg-teal-700 hover:text-teal-100
        bg-teal-100
        text-teal-700
        border duration-200 ease-in-out
