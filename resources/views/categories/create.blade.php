 ...
 <div class="p-0">
                <div class="flex justify-start items-baseline flex-wrap">
                    ...
                    border-teal-600 transition">
                        ...
                        <a href="{{ URL::to('categories/index') }}"  class="text-base  rounded-l-none  hover:scale-110 focus:outline-none flex justify-center px-4 py-2 rounded font-bold cursor-pointer
                    hover:bg-teal-700 hover:text-teal-100
                    bg-teal-100
                    text-teal-700
                    border duration-200 ease-in-out
...
<div class="bg-gray-100  shadow-md rounded px-8 pt-6 pb-8 mb-4 flex flex-col my-2 ">
          ...
          <form class="w-full p-6" method="POST" action="{{ route('categories.store') }}">
            @csrf
           <div class="mx-auto max-w-lg mt-8 ">
              <div class="py-2">
                <span class="px-1 text-sm text-gray-900">Category</span>
