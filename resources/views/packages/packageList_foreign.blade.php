                        ...
                        @section('topic')
                                        ...
                                        <div class="p-2">
                                            <div class="flex justify-start items-baseline flex-wrap">
                                                <div class="flex m-2">
                                                    <a href="{{ route('categories.index') }}" class="text-base  rounded-r-none  hover:scale-110 focus:outline-none flex justify-center px-4 py-2 rounded font-bold cursor-pointer
                                                ...
                                                border-teal-600 transition">
                                                    ...
                                                    <a href="{{ route('packages.create') }}"  class="text-base  rounded-l-none  hover:scale-110 focus:outline-none flex justify-center px-4 py-2 rounded font-bold cursor-pointer
                                                hover:bg-teal-700 hover:text-teal-100
                                                bg-teal-100
                                                text-teal-700
                                                border duration-200 ease-in-out
                        ...
                        <!-- component -->
                        <body class="flex items-center justify-center">   Page {{ $packages->currentPage() }} of {{ $packages->lastPage() }}
                            <div class="container">
                                <table class="w-full flex flex-row flex-no-wrap sm:bg-white rounded-lg overflow-hidden sm:shadow-lg my-5">
                                    ...
                                    <tbody class="flex-1 sm:flex-none">
                                        ...
                                        <tr class="flex flex-col flex-no wrap sm:table-row border bg-gray-100   hover:bg-gray-100  mb-2 sm:mb-0 text-gray-900">
                                            <td class="border-grey-light border   p-2">{{ $package->id}}</td>
                                            <td class="border-grey-light border   p-2 truncate">{{ $package->description  }}</td>
                                            <td class="border-grey-light border   p-2">{{  $package->weight }}</td>
                                            <td class="border-grey-light border   p-2  ">{{ $package->price_cal($package->discount_price) }}</td>
                                            <td class="border-grey-light border   p-2">{{ $package->created_at->format('F d, Y h:ia') }}</td>
                                            <td class="border-grey-light border   p-2 text-red-400 hover:text-red-600 hover:font-medium cursor-pointer">
                                           <div class="flex m-2">
                                                <a href="{{ route('packages.edit', $package->id) }}"  class="text-base  rounded-r-none p-1  hover:scale-110 focus:outline-none flex justify-center  rounded font-bold cursor-pointer
                                                hover:bg-teal-700 hover:text-teal-100
                                                bg-teal-100
                                                text-teal-700
                                                border duration-200 ease-in-out
                                ...
                                border-teal-600 transition">
                                    ...
                                    <a href="{!! route('packages.show', [$package->id]) !!}" class="text-base  rounded-l-none  hover:scale-110 focus:outline-none flex justify-center  p-1 rounded font-bold cursor-pointer
                                hover:bg-teal-700 hover:text-teal-100
                                bg-teal-100
                                text-teal-700
                                border duration-200 ease-in-out
