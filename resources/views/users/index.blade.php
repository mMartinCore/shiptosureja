		...
		<table class="w-full flex flex-row flex-no-wrap sm:bg-white rounded-lg overflow-hidden sm:shadow-lg my-5">
			<thead class="text-gray-900">
				<tr class="bg-teal-400 flex flex-col flex-no wrap sm:table-row rounded-l-lg sm:rounded-none mb-2 sm:mb-0">
                    ...
                    <th class="p-2 text-left">User Roles</th>
			...
			<tbody class="flex-1 sm:flex-none">
                ...
                <tr class="flex flex-col flex-no wrap sm:table-row border bg-gray-100   hover:bg-gray-100  mb-2 sm:mb-0 text-gray-900">
                    ...
                    <td class="border-grey-light border   p-2">{{  $user->roles()->pluck('name')->implode(' ') }}</td>{{-- Retrieve array of roles associated to a user and convert to string --}}
