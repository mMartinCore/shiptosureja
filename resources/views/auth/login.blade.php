...
<div class="bg-gray-100  shadow-md rounded px-8 pt-6 pb-8 mb-4 flex flex-col my-2 ">
         ...
         Login to   SHIP TO SURE
            ...
            <div class="mx-auto max-w-lg">
              <div class="py-2">
                <span class="px-1 text-sm text-gray-900">Email As Username</span>
              ...
              <div class="py-2" x-data="{ show: true }">
                <span class="px-1 text-sm text-gray-900">Password</span>
                <div class="relative">
                  <input name="password" placeholder="" :type="show ? 'password' : 'text'" class="text-lg block px-3 py-2 rounded-lg w-full
                bg-white border-2 border-gray-300 placeholder-gray-600 shadow-md
                text-black
                focus:placeholder-gray-500
                focus:bg-white
